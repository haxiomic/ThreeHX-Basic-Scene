...
class Quaternoin{
	...
	private inline function get_z():Float return v4.z;
	private inline function get_w():Float return v4.w;
	private inline function set_x(val:Float):Float{ updateEuler(); v4.x = val; return v4.x; }
	private inline function set_y(val:Float):Float{ updateEuler(); v4.y = val; return v4.y; }
	private inline function set_z(val:Float):Float{ updateEuler(); v4.z = val; return v4.z; }
	private inline function set_w(val:Float):Float{ updateEuler(); v4.w = val; return v4.w; }
	...
	public function setFromEuler (euler:Euler, update:Bool = true) : Quaternion
	{
		...
		if ( update != false ) this.updateEuler();
