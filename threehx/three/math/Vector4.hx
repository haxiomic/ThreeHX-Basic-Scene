 ...
 */
 ...
 @:noCompletion
@:arrayAccess
abstract Vector4Data(FloatArray) to FloatArray from FloatArray{
	...
	private inline function set_w(val:Float):Float return this[3] = val;
}

@:arrayAccess
abstract Vector4(Vector4Data) to Vector4Data from Vector4Data
{
	public inline function new(x:Float = 0, y:Float = 0, z:Float = 0, w:Float =0){
		this = new Vector4Data(x,y,z,w);
	}
	public var x(get,set):Float;
	public var y(get,set):Float;
	public var z(get,set):Float;
	...
	private inline function set_w(val:Float):Float return this.w = val;

	public inline function toString() return "Vector4("+x+", "+y+", "+z+", "+w+")";
	...
	//!# todo add floor, ceil, round, roundtozero	
