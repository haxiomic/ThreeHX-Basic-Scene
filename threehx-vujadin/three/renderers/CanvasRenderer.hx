...
import three.lights.AreaLight;
import three.lights.HemisphereLight;
import three.materials.Material;
import three.materials.SpriteCanvasMaterial;
import three.materials.ParticleSystemMaterial;
...
import three.renderers.renderables.RenderableSprite;
...
class CanvasRenderer {
	...
	inline private function renderFace3(v1:RenderableVertex, v2:RenderableVertex, v3:RenderableVertex, uv1:Int, uv2:Int, uv3:Int, element:RenderableFace3, material:Material) {
		...
		if ((Std.is(material, MeshLambertMaterial) || Std.is(material, MeshPhongMaterial)) && cast(material, MeshLambertMaterial).map == null) {
			...
			_color1.r = _color1.g = _color1.b = 1 - MathUtils.smoothstep(v1.positionScreen.z * v1.positionScreen.w, _near, _far);
			_color2.r = _color2.g = _color2.b = 1 - MathUtils.smoothstep(v2.positionScreen.z * v2.positionScreen.w, _near, _far);
			_color3.r = _color3.g = _color3.b = 1 - MathUtils.smoothstep(v3.positionScreen.z * v3.positionScreen.w, _near, _far);
			_color4.addColors(_color2, _color3).multiplyScalar(0.5);
