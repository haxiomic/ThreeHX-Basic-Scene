...
import three.renderers.shaders.UniformsLib.ULTypeValue;
import three.renderers.shaders.ShaderLib;
import three.extras.objects.ImmediateRenderObject;
import three.extras.objects.LensFlare;
import three.math.Vector4;
import three.renderers.shaders.UniformsUtils;
import three.renderers.WebGLRenderer.Lights;
import three.renderers.WebGLRenderer.ThreeGLMaterial;
import three.renderers.WebGLRenderer.ThreeGLProgram;
...
import three.extras.renderers.plugins.ShadowMapPlugin;
...
typedef ThreeGLProgram = {
	...
	uniforms: Null<Map<String, openfl.gl.GLUniformLocation>>
}
